...
jobs:
  terraform:
    uses: appvia-lz-aws-dev/cicd-workflows/.github/workflows/terraform-plan-and-apply-aws.yml@main
    name: Plan and Apply
    with:
...
jobs:
  terraform-destroy:
    uses: appvia-lz-aws-dev/cicd-workflows/.github/workflows/terraform-destroy.yml@main
    name: Destroy
    with:
      aws-account: 123456789012
      aws-role: <IAM_ROLE_NAME>
